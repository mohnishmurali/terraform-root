...
ec2_instances = {
  "web-server-1" = { ami_id = "ami-01a00762f46d584a1", instance_type = "t2.small", subnet_key = "public-subnet-1" }
  "web-server-2" = { ami_id = "ami-01a00762f46d584a1", instance_type = "t2.small", subnet_key = "public-subnet-2" }
}
